"""
Django settings for testapp_45308 project.
...
ROOT_URLCONF = 'testapp_45308.urls'
...
WSGI_APPLICATION = 'testapp_45308.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapp_45308 API",
    "DESCRIPTION": "API documentation for testapp_45308 App",
    "VERSION": "v1",
}
